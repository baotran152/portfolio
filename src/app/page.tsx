  ...
  function StatusButton({ isOpen }: StatusButtonProps) {
    return (
      <div className="absolute top-6 left-6 z-20">
        <button
          className={`relative flex cursor-pointer items-center gap-2 rounded-full border px-4 py-1.5 text-sm font-medium shadow-md backdrop-blur-lg transition
            ${isOpen 
              ? 'bg-white/30 text-black hover:bg-white/60 dark:border-white dark:text-white dark:hover:bg-neutral-800' 
              : 'bg-white/30 text-black hover:bg-white/60 dark:border-white dark:text-white dark:hover:bg-neutral-800'}
          `}
        >
          {/* Pulse dot */}
