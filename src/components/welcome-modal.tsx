            ...
            <DialogHeader className="relative flex flex-row items-start justify-between px-8 pt-8 pb-6">
              <div>
                ...
                <DialogDescription className="mt-2 text-base">
                  An interactive experience powered by real AI
                </DialogDescription>
              </div>
              <Button
                variant="ghost"
              ...
              <section className="bg-accent w-full space-y-8 rounded-2xl p-8">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-accent-foreground text-base leading-relaxed">
                    This portfolio is a conversational interface powered by AI.
                    You can ask me anything about my work, projects, experience, or skills—
                    just like you would in an interview or casual chat.
                  </p>
                </div>
